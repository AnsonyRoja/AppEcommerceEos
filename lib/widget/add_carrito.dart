     ...
     //final proveedor = Provider.of<AuthBlock>(context,listen: false);
                  ...
                  builder: (context, res) {
                    if (res.connectionState == ConnectionState.done) {
                       ...
                       Map<dynamic, dynamic> rowCarrito = res.data as Map<dynamic, dynamic>;
...
return RawMaterialButton(
  onPressed: () async{
         ...
         if (widget.pedidoMaximo != null && _cant > widget.pedidoMaximo! && widget.pedidoMaximo != 0) {
            msj("Máximo permitido.");
          } else {
            if (widget.stock != null && _cant > widget.stock!) {
              msj("Stock Agotado.");
            } else {
              _cant = _cant + 1;
