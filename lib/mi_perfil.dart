...
class _MiPerfilState extends State<MiPerfil> {
  ...
  var campo = {'cities_id': null, 'rif': '', 'tipoRif': '', 'sex': '', 'name': '', 'birthdate': ''};
  ...
  Future<bool> _showSelectionDialog(context) async {
              ...
              FutureBuilder(
                ...
                builder: (context, AsyncSnapshot projectSnap) {
                  if (projectSnap.connectionState == ConnectionState.done) {
                    ...
                    Map rowSelect = {'nroCedula': row['nro_rif'], 'nacionalidad': row['nacionalidad']};
                    ...
                    return Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: <Widget>[
                          ...
                          _campoTexto('name', 'Nombre y apellido', 'todo', true, row['name']),
                          Cedula(
                            row: rowSelect,
  ...
  _guardarPerfil(campo) async {
    ...
    //print(res);
    Map res = await peticionPost(url, {'rif': rif, 'sex': sex, 'name': name, 'birthdate': birthdate, 'phone': phone});
  ...
  Future<void> _selectDate(BuildContext context) async {
    final DateTime? picked = await showDatePicker(
      ...
      locale: Locale('es'), // Establecer el locale a español
    );
    if (picked != null && picked != selectedDate) {
      setState(() {
        primeraVez = false;
        selectedDate = picked;
        _actualizarFecha(DateFormat('yyyy-MM-dd').format(selectedDate));
      });
    }
  }
