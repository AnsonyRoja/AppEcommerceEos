...
class HomeState extends State<Home> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: Padding(
            padding: const EdgeInsets.only(left: 7.00),
            child: InkWell(
              onTap: () async {
                await delEvento();
              ...
              child: const Image(image: AssetImage("assets/images/ico2.png")),
            )),
        ...
        title: Container(
          height: 45,
          child:  Card(
              margin: const EdgeInsets.only(left: 7.00),
              child: Container(
                padding: const EdgeInsets.only(left: 7.00, right: 7.00),
                child: Row(
                  children: <Widget>[
                    // Flexible(
                    //   child: buscador(),
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            padding: const EdgeInsets.only(left: 9.00),
          ),
          //
  ...
  builder: (context, projectSnap) {
    if (projectSnap.connectionState == ConnectionState.done) {
      print('Esto es el projectSnap $projectSnap');

         Widget childWidget;
      if (projectSnap.data is Widget) {
      ...
      return WillPopScope(
        ...
        onWillPop: () async {
          ...
          if (_selectedIndex == 1) {
            ...
            // Aquí puedes manejar otra lógica de navegación o cierre de la aplicación
  ...
  Future<Widget> vista() async {
    ...
    print('Esto es el selectedIndex $_selectedIndex');
    ...
    switch (_selectedIndex) {
      case 0:
        return Principal(
          actualizarHome: _actualizarEvento,
          publicidad: _listarPublicidadTop!,
          listadoProductos: _listarProductosHome!,
        );
      case 1:
  ...
  buscarProducto(texto) async {
    ...
    List<String> data = []; //esto es para que detecte una lista vacia y muestre el mensaje sin error de que no hay resultados
