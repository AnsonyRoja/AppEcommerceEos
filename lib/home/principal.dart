...
verifyPublicity() async {


  dynamic cargar = await widget.publicidad;

  print('Cargar publicidad $cargar');
...
void initState() {
 ...
 List agregarImagenList(Map<String, dynamic> data) {
  ...
  listaPublicidad() {
    ...
    return SizedBox(
        ...
        child:  FutureBuilder(
          ...
          builder: (BuildContext context, AsyncSnapshot snapshot) {
            print("Este es el snapshot Data en listar publicidad ${snapshot.data}");
  ...
  _banner(String rutaImagen) {
    return Container(
      child: Padding(
        padding: const EdgeInsets.only(top: 6.0, left: 8.0, right: 8.0, bottom: 10),
        child: Image(
          fit: BoxFit.cover,
  ...
  cajaProductos(products) {
    ...
    return List.generate(products.length, (index) {
      print('Estos son los productos en cajaproductos  y este es el $index');
