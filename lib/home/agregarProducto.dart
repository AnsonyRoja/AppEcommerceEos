...
class AgregarProducto extends StatefulWidget {
  ...
  final int pedidoMax;
  final int id;
  const AgregarProducto({Key? key, required this.precioDolar, required this.precioBolivar, required  this.id, required this.stock, required this.pedidoMax}) : super(key: key);
  @override
...
class _AgregarProductoState extends State<AgregarProducto> {
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder(
      future: proveedor.getCarritob(contexto: context),
      builder: (context, AsyncSnapshot obj) {
