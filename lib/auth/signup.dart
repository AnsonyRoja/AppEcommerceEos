...
class _SignUpState extends State<SignUp> {
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Row(
                            children: <Widget>[
                              Expanded(
                                child: _campoTextoConSelect(
                                    'rif', 'Cedula o Rif', 'Por favor ingrese su Nro. de cedula o rif', 'tipoRif', <String>['V', 'J', 'G']),
                              ),
  ...
  _campoSexo() {
    return Row(children: [
      new Text(
        'Sexo :',
        style: new TextStyle(fontSize: 17.0, color: Color(0xff777777)),
      ),
      new Row(
        mainAxisAlignment: MainAxisAlignment.center,
        children: <Widget>[
