...
class _CartListState extends State<Carrito> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    if (cargadoArgumento == false) {
      ...
      actualizar_pagina_anterior = ModalRoute.of(context)!.settings.arguments as bool;
    }
...
//Future.delayed(Duration(seconds: 3));
                ...
                itemBuilder: (context, index) {
                  ...
                  return Dismissible(
                    ...
                    onDismissed: (direction) async {
                      ...
                      await setCarrito(int.parse(item['id']), 0);
                      //Scaffold.of(context).showSnackBar(SnackBar(content: Text(), duration: Duration(seconds: 1)));
                      msj(item['name'] + " Eliminado del carrito");
                    ...
                    child: InkWell(
                      onTap: () {
                        ...
                        String priceDolar = formatDolar.format(double.parse(item['total_precio_dolar']));
                        double precioDolar = double.parse(item['total_precio_dolar']);
                        double precioBolivar = double.parse(item['total_precio']);

                        String price = formatBolivar.format(double.parse(item['total_precio']));
                            ...
                            leading: ClipRRect(
                              ...
                              child: Container(
                                ...
                                child: CachedNetworkImage(
                                  fit: BoxFit.cover,
                                  imageUrl: BASE_URL_IMAGEN + item['image'],
                                ...
                                Row(
                                  children: <Widget>[
                                    Padding(
                                      ...
                                      child: Text('X ' + item['cant'].toString(),
                                          style: TextStyle(
                ...
                Padding(
                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Text("$_totalDolaresConFormato / $_totalBolivaresConFormato", style: TextStyle(fontSize: 23, fontWeight: FontWeight.bold)),
                    ],
                  ),
                ),
                Padding(
    ...
    return Column(
      children: <Widget>[
        Padding(
          ...
          child: textoTop2(
              "Direcciones de entrega"), //Text(products.length.toString() + " Productos en tu carrito", textDirection: TextDirection.ltr, style: TextStyle(color: Colors.black, fontWeight: FontWeight.bold))
        ),
        Divider(),
        Padding(
        ...
        Padding(
          ...
          child: ListTile(
            title: Text(
              "Retirar en tienda PIDE",
              style: TextStyle(fontWeight: FontWeight.bold),
            ),
            subtitle: Container(child: Text("Villas Park Market, Av. Circunvalación, Residencias Villas Park, Local 05 PB.")),
            trailing: Radio(
              value: 0,
            ...
            child: Column(
              children: <Widget>[
                ...
                Row(
                  children: <Widget>[
                    Text(
                      "Hora de entrega o retiro: ",
                      style: TextStyle(fontSize: 15),
                    ),
                    Expanded(child: HoraEntrega())
                  ],
                ),
              ],
            )),
  ...
  _btnIniciarSesion() {
    return ElevatedButton(
      ...
      style: ButtonStyle(
          ...
          backgroundColor: WidgetStateProperty.all<Color>(Color(colorRojo)),
  ...
  _btnRegistrarme() {
    return ElevatedButton(
      child: Text("Registrarme", style: TextStyle(fontSize: 14)),
      style: ButtonStyle(
          foregroundColor: WidgetStateProperty.all<Color>(Colors.white),
          backgroundColor: WidgetStateProperty.all<Color>(Color(colorVerde)),
          shape: WidgetStateProperty.all<RoundedRectangleBorder>(RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(7.0),
    ...
    if (_recargo) {
      return Row(
        children: [
          Expanded(
              child: Text(
            "Costo de envío: $_varprecioEnvioD / " + _varprecioEnvio,
            style: TextStyle(
              fontSize: 18,
            ),
